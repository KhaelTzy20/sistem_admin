...
@section('content')
    <div class="employee-page">
        ...
        <form method="GET" action="/employees" class="search-box">
            ...
            <input type="text" name="search" placeholder="Cari Nama, KTP, Divisi, Status..."
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    ...
                                    {{-- DETAIL --}}
                                    <a href="{{ route('employees.show', $e->id) }}" class="btn btn-dark btn-sm">
                                        🔍
                                    </a>

                                    {{-- EDIT --}}
                                    <a href="{{ route('employees.edit', $e->id) }}" class="btn btn-primary btn-sm">
                                        ✏️
                                    </a>
