...
<div class="employee-form-page">
    ...
    <h3 class="page-title">✏️ Edit Employee</h3>
    ...
    <form method="POST" action="{{ route('employees.update', $employee->id) }}">
        ...
        <div class="grid-2">
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    value="{{ old('employee_id_number', $employee->employee_id_number) }}">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <select name="gender_id" class="select2">
        ...
        <div class="form-group">
            ...
            <input
                name="main_address"
                value="{{ old('main_address', $employee->main_address) }}">
        </div>
        ...
        <div class="form-group">
            ...
            <input
                ...
                value="{{ old('alternate_address', $employee->alternate_address) }}">
        </div>
        ...
        <div class="grid-2">
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    value="{{ old('corporate_phone_number', $employee->corporate_phone_number) }}">
            </div>
        </div>
        ...
        <div class="grid-2">
            ...
            <div class="form-group">
                ...
                <select name="marriage_status_id" class="select2">
                    <option value="">-- Status Pernikahan --</option>

                    @foreach($marriageStatuses as $m)
                        <option
                            value="{{ $m->id }}"
                            {{ old('marriage_status_id', $employee->marriage_status_id) == $m->id ? 'selected' : '' }}>
                            {{ $m->name }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input
                    type="number"
                    name="total_child"
                    value="{{ old('total_child', $employee->total_child) }}">
            </div>
        ...
        <div class="grid-2">
            ...
            <div class="form-group">
                ...
                <select name="division_id" class="select2">
        ...
        <div class="grid-2">
            ...
            <div class="form-group">
                ...
                <select name="work_status_id" class="select2">
                    <option value="">-- Status Kerja --</option>

                    @foreach($workStatuses as $w)
                        <option
                            value="{{ $w->id }}"
                            {{ old('work_status_id', $employee->work_status_id) == $w->id ? 'selected' : '' }}>
                            {{ $w->name }}
                        </option>
                    @endforeach
                </select>
        ...
        Resign
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    value="{{ old('start_work_date', $employee->start_work_date) }}">
            </div>
